    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('apiMethod', models.CharField(choices=[('GET', 'GET'), ('POST', 'POST'), ('PUT', 'PUT'), ('DELETE', 'DELETE')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userClass', models.CharField(default='WebsiteActiveUser', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changeType', models.CharField(choices=[('money', 'Money'), ('moneyAfterTransactions', 'Money After Transactions')], max_length=40)),
